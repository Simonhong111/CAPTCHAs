...
#     drops=drops(im)
    ...
    VerticalProjection_re = VerticalProjection(im)
    zonexCutLines_re = zonexCutLines(zoneL, zoneBegins) #没起作用
    yVectors_sorted_re = yVectors_sorted(zoneBE,VerticalProjection_re)
    drops = get_dropsPoints(zoneL, zonexCutLines_re, yVectors_sorted_re)
